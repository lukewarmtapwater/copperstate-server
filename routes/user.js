...
router.delete("/:userId",
  ...
  async (req, res, next) => {
    ...
    try {
      ...
      await connection.execute("UPDATE cars SET createdBy = NULL WHERE createdBy = ?", [userId]);
      await connection.execute("UPDATE cars SET statusUpdatedBy = NULL WHERE statusUpdatedBy = ?", [userId]);
